...
OSOL stands out from other IT reuse organizations by focusing on education, sustainability, and accessibility for students. Here’s how:
\begin{itemize}
	...
	\item \textbf{Online Learning Recommendation:} OSOL recomments students with trusted free online educational resources to enhance learning.
	\item \textbf{Offline Access:} For students without internet, OSOL pre-installs offline educational content and even AI-powered chatbot, ensuring they can still learn.
\end{itemize}
...
\end{wrapfigure}
Labdoo.org is a non-profit collaborative platform that allows unused laptops loaded with educational applications to reach schools throughout the world without incurring any economic cost and without generating additional $CO_2$ emissions to the Planet. Thanks to the collaboration of thousands of people around the globe, the Labdoo humanitarian platform has grown to support over 2,600 schools in more than 148 countries, deploying more than 300 operational hubs spread over the five continents and benefiting more than 825,000 students from around the globe.

Everyone involved in the Labdoo project is a volunteer and none of Labdoo members receives any remuneration for the time contributed to the cause, other than the satisfaction of seeing the joy of a child receiving education.
...
Computer Aid International is a UK-based charity and social enterprise that works to bridge the digital divide by providing refurbished computers and other ICT equipment to educational institutions and non-profit organizations in developing countries. Their headquarters is in London and offices in South Africa, their team works across projects spanning Africa, Latin America, Europe, and Australia.
...
\begin{wrapfigure}{l}{0.5\textwidth}
	\centering
	\includegraphics[width=0.9\linewidth]{fig-logo-computer4school-Kenya}
\end{wrapfigure}

Computer For Schools Kenya (CFSK) is a charitable non-governmental organization registered in the year 2002, and now has eight Regional Centres hosted by various Government institutions country-wide. Their head office is located in Mihango Utawala, Embakasi, off the Eastern Bypass near the AP/GSU Training College Nairobi, Kenya.
...
They have successfully developed digital multimedia teaching and learning resources specifically intended for our national Secondary School curriculum – providing both teachers and students with an invaluable modern tool that makes learning stimulating. They have also carried out computer proficiency training to over 100,000 school principals, Education Officers and teachers.
...
Their organizational and operational model has been recognized as an exemplar, with ongoing efforts to replicate the same in other African countries such as Uganda, Tanzania, Burundi, Rwanda, Nigeria, South Sudan, Malawi and Namibia.
...
Since 2003, Close the Gap has already received more than 1 499 716 ICT devices from companies all over the world. Today, Close the Gap has supported more than 10 670 projects in more than 50 countries (mostly in Africa), and reached more than 5 496 807 beneficiaries.
...
\subsubsection{Online education content}
\begin{enumerate}
...
\end{enumerate}
\subsubsection{Offline education content}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{fig-serverless-web-app}
...
\subsection{Step 1}
\begin{enumerate}
\item one place to store these out-of-date IT equipments.
