...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\linewidth]{fig-osol-db-osol-communication-mean}
	\caption{OSOL database metadata - osol.communication\_mean}
	\label{fig:osol-db-osol-communication-mean}
\end{figure}
