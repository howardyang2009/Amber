...
The RCC provides centralized computing power and data storage for Riverty by repurposing older, end-of-life IT equipment.

\subsection{General Rules}
\begin{enumerate}
	\item OSOL provides IT equipment to students and schools free of charge.
	\item OSOL retains ownership of all provided IT equipment.
	\item In the event that equipment is lost, the student or school will not be charged. However, a replacement will only be provided when the lost item was scheduled to be recalled, typically after 2 to 3 years.
\end{enumerate}
...
\item two persons to confirm and monitor each other.
\end{enumerate}
